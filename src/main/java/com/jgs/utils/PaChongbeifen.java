...
public class PaChongbeifen {
    ...
    public PaChongbeifen(Long collectRuleId, AdminService adminService, HttpServletResponse response, String bookInfoUrl, String bookName, int bookNameNum, String bookType, int bookTypeNum, String bookIntro, int bookIntroNum, String bookMuluUrl, String bookChapterUrl, String bookText, int bookTextNum, String bookImage, Integer bookImageNum, String bookAuthor, Integer bookAuthorNum, Long start, Long end) {
...
//                httpGet.setHeader("Host", "www.17k.com");
                ...
                response.getWriter().write(i+":"+bookName+pp+"</br>");
...
//           httpGet.setHeader("Host", "www.17k.com");
                ...
                while(statusCode!=200&&tryCount<3)
                {
                    ...
                    try {
                        ...
                        inputStream=myrResponse.getEntity().getContent();
                        File file=new File("c:/bookimage/");
                        if (!file.exists())
                        {
                            file.mkdirs();
                        }
                        FileOutputStream outputStream=new FileOutputStream("c:/bookimage/"+article.getId()+".jpg");
                        int len=0;
